...
<html>
	<head>
		...
		<script>
		  ...
		  gtag('config', 'UA-121181555-1');
		</script>
	</head>
	<body>
		<div id="wrapper">
			<header id="header">
				<span class="avatar"><img src="images/logo.png" alt="CRDesigner" /></span>
				<h1><strong>Site em construção, aguarde novidades em breve!</strong></h1>
				<ul class="icons">
			...
			<footer id="footer">
				<p>Copyright &copy; 2018 <a href="http://www.crdesigner.com.br" target="_blank">CRDesigner</a>.</p>
			</footer>
		</div>
